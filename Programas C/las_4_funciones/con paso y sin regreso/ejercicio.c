...

{
    ...
    gotoxy(27,31); 
    printf("El resultado es : %0.2f           ", resultado);
...
{ 
...

    {
    	case 1 :  
    	        ...
    	        centigrados_a_fahrenheit(grados);    //llamamos a la funcion y le mandamos eso para que nos devuelva lo que hay en la funcion
        ...
        case 2 :  
    	         ...
    	         fahrenheit_a_centigrados(grados) ;   //llamamos a la funcion ten esto y dame eso
        ...
        case 3 :   
    	        ...
    	        centigrados_a_kelvins(grados) ;  //llamada de la funcion le enviamos eso y que nos de lo que contenga
