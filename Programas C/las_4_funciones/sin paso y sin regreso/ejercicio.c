...

{
    ...
    gotoxy(27,31);  printf("El resultado es : %0.2f           \n",resultado);
	


}

void fahrenheit_a_centigrados () 
...
{ 
...

    {
        ...
        case 3 :  
    	          ...
    	          centigrados_a_kelvins ();

    	          									break ;

    	case 4 :  

    	          kelvins_a_centigrados ();
